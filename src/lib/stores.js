...
export const race       = writable({ curLap: null, totLap: null, coins: null, mushrooms: 0,
                                     splits: {}, finishTime: null, elapsedMs: null, dnf: false });
...
export const activity      = writable([]);   // normalized activity rows, newest feed-ts first (web/src/lib/activityMerge.js)
