...
import { buildReference, lapBoundaries, completionFraction, resolveCompletion } from './completion';
...
describe('lapBoundaries', () => {
  it('places the lap-1 boundary at the route fraction matching its end-time', () => {
    ...
    expect(lapBoundaries(ref, [100, 200])).toEqual([0.5, 1]); // lap1 ends at t=100 -> s=0.5
  });
});
