...
## 3. Sounds (amended 2026-07-22)

Synthesized authentic Australian network tones, generated by
`hotline/server/scripts/gen_sfx.py` into `hotline/server/hotline/static/sfx/` (the original
MicroSIP wavs were generic European tones: `ringing.wav` was a single flat 425 Hz sine;
dropped after Paul's audition, 2026-07-22):
